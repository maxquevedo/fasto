...
ALTER TABLE "sistema_especifico" ADD CONSTRAINT "fk_sistema_especifico_sistema_especifico_1" FOREIGN KEY ("id_sistema") REFERENCES "sistema" ("id") ON DELETE CASCADE;
ALTER TABLE "sistema_especifico" ADD CONSTRAINT "fk_sistema_especifico_sistema_eshop_1" FOREIGN KEY ("id_especifico") REFERENCES "sistema_eshop" ("id") ON DELETE CASCADE;
ALTER TABLE "sistema_especifico" ADD CONSTRAINT "fk_sistema_especifico_agenda" FOREIGN KEY ("id_especifico") REFERENCES "sistema_agenda" ("id") ON DELETE CASCADE;

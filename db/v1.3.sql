...
ALTER TABLE "inventario" ADD CONSTRAINT "fk_tienda_invent" FOREIGN KEY ("id_tienda") REFERENCES "sistema_eshop" ("id") ON DELETE CASCADE;
...
ALTER TABLE "sistema_agenda" ADD CONSTRAINT "fk_sistema_agenda_sistema_especifico_1" FOREIGN KEY ("id_sistema_especifico") REFERENCES "sistema_especifico" ("id");
...
ALTER TABLE "venta_eshop" ADD CONSTRAINT "fk_pago_venta" FOREIGN KEY ("id_venta") REFERENCES "pago" ("id") ON DELETE CASCADE;
